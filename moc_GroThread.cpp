...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_GroThread_t, stringdata) + ofs \
...
QT_MOC_LITERAL(6, 51, 11)
    ...
    "stateChange\0message\0std::string\0"
};
...
const QMetaObject GroThread::staticMetaObject = {
    { &QThread::staticMetaObject, qt_meta_stringdata_GroThread.data,
      qt_meta_data_GroThread,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_GroThread.stringdata))
